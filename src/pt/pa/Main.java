...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(grades.computeStatistic()); // average
        grades.changeStatistic(new StatisticHighest());
        System.out.println(grades.computeStatistic()); // highest
        grades.changeStatistic(new StatisticLowest());
        System.out.println(grades.computeStatistic()); // lowest
    }
